...
import com.example.Rsyzw.activitys.LoginActivity;
import com.example.Rsyzw.helps.RealmHelper;
import com.example.Rsyzw.helps.UserHelper;
import com.example.Rsyzw.models.UserModel;
...
//        定义Activity跳转动画
    ...
    public static boolean registerUser (Context context, String phone, String password, String passwordConfirm) {
        ...
        if (StringUtils.isEmpty(password) || !password.equals(passwordConfirm)) {
            Toast.makeText(context, "请输入密码并确认保持一致", Toast.LENGTH_SHORT).show();
            return false;
        }
